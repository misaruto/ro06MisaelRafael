...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/encadeada

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/encadeada: ${OBJECTFILES}
...
${OBJECTDIR}/Encadeada.o: Encadeada.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Encadeada.o Encadeada.cpp
